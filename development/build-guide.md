...
Define what device you’re going to build. For example, the Nexus 5X, has a codename of `sunfish`. You can check your specific device's codename on GitHub or on Google. Execute:
